...
# ========== 常量配置 ==========
# 股票池从 data_fetcher.A_SHARE_POOL 派生（排除小盘/高波动标的，保持与历史行为一致）
_EXCLUDED_FROM_POOL = {
    "000002", "000425", "000876", "000938", "002001", "002024", "002714",
    "600009", "601118", "603288", "603501", "603799", "603986",
}
STOCK_POOL = [s["code"] for s in df.A_SHARE_POOL if s["code"] not in _EXCLUDED_FROM_POOL]
